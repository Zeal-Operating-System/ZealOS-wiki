...
2. Launch a new virtual machine with the latest ISO and the hard disk.
  * `qemu-system-x86_64 -machine q35,kernel_irqchip=off -cdrom ZealOS-YYYY-MM-DD-HH_MM_SS.iso -hda ZealOS.qcow2 -m 4G -smp 4 -accel kvm -rtc base=localtime -soundhw pcspk -nic user,model=virtio-net-pci`
3. Start the VM.
